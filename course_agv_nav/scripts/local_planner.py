...
class LocalPlanner:
    ...
    def laserCallback(self,msg):# 获取返回的激光信息
        # print("get laser msg!!!!",msg)
        self.laser_lock.acquire()# 获取激光信息
        # preprocess
        self.ob = [[100,100]]
        ...
        for i in range(len(msg.ranges)):
            ...
            r = msg.ranges[i]
            if r < self.threshold:# 距离短到成为障碍物
                self.ob.append([math.cos(a)*r,math.sin(a)*r]) #加入障碍物序列
        self.laser_lock.release() #解锁激光信息
        pass
